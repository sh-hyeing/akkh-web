...
export default function App() {
 ...
 return (
  ...
  <div
   className="min-h-screen w-full flex items-center justify-center p-4 pb-[10vh] md:pb-0"
   style={{
   ...
   >
    ...
    >
     ...
     <div style={{ position: "relative", width: "100%", height: "100%" }}>
      ...
      />
      <Letter isOpen={isOpen} messages={messages} onAddMessage={addMessage} onDeleteMessage={deleteMessage} onEditMessage={editMessage} />
